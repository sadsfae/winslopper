...
- The optional Stable Diffusion WebUI image API also needs Python 3.11/3.12, Git for Windows, an NVIDIA GPU (CUDA-capable torch), and a model checkpoint (see below).
...
1. Install **Python 3.11 or 3.12** and **Git for Windows** (`winget install Python.Python.3.12`, `winget install Git.Git`).
