...
1. Install **Python 3.11 or 3.12** and **Git for Windows** (`winget install Python.Python.3.12`, `winget install Git.Git`), or download them directly: [Python](https://www.python.org/downloads/) and [Git for Windows](https://git-scm.com/download/win). Use 3.12 if you can (3.11 stopped shipping installers; the WebUI rejects 3.13+). All Python activity stays inside `sd\\venv`.
