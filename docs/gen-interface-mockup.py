...
def load_font(size, bold=False):
    candidates = [
        ...
        if bold else "/usr/share/fonts/adwaita-mono-fonts/AdwaitaMono-Regular.ttf",
    ]
...
LINES = [
    ...
    [("  1) ", CYAN), ("Start server - logs stream in this window; closing it stops", GRAY)],
...
ox, oy = PAD, PAD
d.rounded_rectangle([ox, oy, ox + W * scale, oy + H * scale], radius=10 * scale, fill=BG, outline=BORDER, width=2 * scale)
